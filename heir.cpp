...
const std::unordered_map<std::string, std::uint8_t> letters = {
    ...
    {"コ", 90}, {"サ", 91}, {"シ", 92}, {"ス", 93},
    {"セ", 94}, {"ソ", 95}, {"タ", 96}, {"ツ", 97},
    {"テ", 98}, {"ト", 99}, {"ナ", 100}, {"ニ", 101},
    {"ハ", 102}, {"ヒ", 103}, {"フ", 104}, {"ヘ", 105},
    {"ホ", 106}, {"マ", 107}, {"ミ", 108}, {"メ", 109},
    {"モ", 110}, {"ヤ", 111}, {"ラ", 112}, {"リ", 113},
    {"ル", 114}, {"レ", 115}, {"ロ", 116}, {"ン", 117},
    {"ァ", 118}, {"ィ", 119}, {"ャ", 120}, {"ョ", 121},
    {"ッ", 122}, {"ー", 123}, {"Ａ", 124}, {"Ｂ", 125},
    {"・", 126}, {"が", 0x80 + 17}, {"ぎ", 0x80 + 18}, {"ぐ", 0x80 + 19},
